...
const debugRouteLinkMap = {
  ...
  '/onboardingPage':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=onboardingPage',
  '/authPage':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=authPage',
  '/appSettings':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=appSettings',
  '/profilePage':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=profilePage',
  '/reportBug':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=reportBug',
  '/requestFeature':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=requestFeature',
  '/supportPage':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=supportPage',
  '/tutorialPage':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=tutorialPage',
  '/selectLanguage':
      'https://app.flutterflow.io/project/vrinda-kriyeta4-tllf8o?tab=uiBuilder&page=selectLanguage',
  '/datamanagePage':
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: Ai2Widget.routeName,
          path: Ai2Widget.routePath,
          requireAuth: true,
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'ai2') : Ai2Widget(),
        ),
        FFRoute(
          name: Account4Widget.routeName,
          path: Account4Widget.routePath,
          requireAuth: true,
        ...
        FFRoute(
          name: ReportBugWidget.routeName,
          path: ReportBugWidget.routePath,
          builder: (context, params) => ReportBugWidget(),
        ),
        FFRoute(
          name: RequestFeatureWidget.routeName,
          path: RequestFeatureWidget.routePath,
        ...
        FFRoute(
          name: DatamanagePageWidget.routeName,
          path: DatamanagePageWidget.routePath,
          builder: (context, params) => DatamanagePageWidget(),
        ),
        FFRoute(
          name: SensoralertPageWidget.routeName,
          path: SensoralertPageWidget.routePath,
          builder: (context, params) => SensoralertPageWidget(),
        ),
        FFRoute(
          name: Analytics3Widget.routeName,
          path: Analytics3Widget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'analytics3')
              : NavBarPage(
